...
.eqv IN   0xFFFF0012  # chua byte dieu khien dong cua ban phim
                      
.eqv OUT 0xFFFF0014  # chua byte tra ve vi tri cua phim duoc bam
...
Nhapsothu:   # cho phep chay .text va .ktext chay ngam song song
...
getInt2: 
	addi $sp,$sp,4
      	sw $ra,0($sp) 
      	li $t1,IN
      	li $t3,0x82     #  cho phep bam phim o hang 1
      	sb $t3,0($t1)
      	li $t1,OUT
      	lb $t3,0($t1)   # Nhan byte the hien vi tri cua phim duoc bam trong hang 1
case_4:   
